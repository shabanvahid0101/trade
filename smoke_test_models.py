...
from crypto_predictor import horizon_model_paths
...
def smoke_test(symbol: str, timeframe: str, horizons: list[int], sanitize: bool) -> None:
...
if __name__ == "__main__":
    ...
    smoke_test(args.symbol, args.timeframe, parse_horizons(args.horizons), args.sanitize)
